# Generated by Django 3.2.13 on 2022-05-17 07:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_number', models.CharField(max_length=10, unique=True, validators=[django.core.validators.RegexValidator('^((\\+91|91|0)[\\- ]{0,1})?[456789]\\d{9}$', code='invalid_mobile', message='Please Enter 10/11 digit mobile number or landline as 0<std code><phone number>')], verbose_name='Contact Number')),
                ('whatsapp_number', models.CharField(max_length=10, unique=True, validators=[django.core.validators.RegexValidator('^((\\+91|91|0)[\\- ]{0,1})?[456789]\\d{9}$', code='invalid_mobile', message='Please Enter 10/11 digit mobile number or landline as 0<std code><phone number>')], verbose_name='Whatsapp Number')),
                ...
                ('date_of_birth', models.CharField(blank=True, default='', max_length=20, verbose_name='Date of Birth')),
                ...
                ('district_current', models.CharField(max_length=100, verbose_name='Permanent District')),
                ...
                ('district_permanent', models.CharField(max_length=100, verbose_name='Permanent District')),
                ...
                ('profile_image', models.URLField(blank=True, default='', verbose_name='Profile Image Url')),
